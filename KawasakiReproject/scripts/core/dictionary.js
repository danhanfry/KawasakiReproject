var Dictionary = (function () {
    function Dictionary() {
        ...
        this.All = function (predicate) {
            return _this.ToArray().every(predicate);
        };
        ...
        this.DefaultIfEmpty = function (defaultValue) {
            return _this.Count() ? _this : new Dictionary();
        };
        ...
        this.ForEach = function (action) {
            return _this.ToArray().forEach(action);
        };
        ...
        this.Remove = function (key) {
            if (_this.ContainsKey(key)) {
                return (_this.RemoveAt(_this.IndexOf(key)), true);
            }
            return false;
        };
        this.RemoveAt = function (itemIndex) {
            _this.ToArray().splice(itemIndex, 1);
        };
